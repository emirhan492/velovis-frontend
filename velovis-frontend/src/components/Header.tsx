  ...
  return (
    <header className="bg-black/90 backdrop-blur-md border-b border-zinc-900 sticky top-0 z-50 transition-all duration-300">
      <nav className="container mx-auto flex items-center justify-between px-4 py-4">
        ...
        {/* 1. LOGO (SOL) */}
        <Link href="/" className="text-xl md:text-2xl font-light tracking-[0.2em] text-white uppercase hover:opacity-80 transition-opacity pl-5">
          Velovis
        </Link>
        ...
        <div className="flex items-center gap-4 md:gap-8">
          ...
          {/* Hikayemiz: HEM TELEFONDA HEM BİLGİSAYARDA GÖRÜNSÜN */}
          ...
          <Link href="/cart" className="text-zinc-400 hover:text-white relative transition-colors group flex items-center gap-1">
            {/* Mobilde sadece ikon, masaüstünde ikon+yazı olabilir ama sade olsun diye ikon yeterli */}
            ...
            <Menu as="div" className="relative inline-block text-left">
              <div>
                <Menu.Button className="flex items-center text-zinc-400 hover:text-white focus:outline-none transition-colors">
                  ...
                  {/* Masaüstünde isim yazsın, mobilde sadece ikon kalsın */}
